...
$this->title = Yii::t('app', 'submission.title_create') . ' — MachoMtaa';
?>
...
<div class="mm-fursa-hero">
    <div class="mm-fursa-hero-inner">
        <div class="mm-fursa-eyebrow">
            <i class="bi bi-building-add"></i> <?= Html::encode(Yii::t('app', 'submission.eyebrow')) ?>
        </div>
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h1 class="mm-fursa-hero-title mb-2"><?= Html::encode(Yii::t('app', 'submission.title_create')) ?></h1>
                <p class="mm-fursa-hero-lead mb-0">
                    <?= Html::encode(Yii::t('app', 'submission.sub_create')) ?>
                </p>
            </div>
...
<div class="mm-fursa-form-wrapper">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                <?= $form->field($model, 'price', [
                    'inputOptions' => ['class' => 'form-control mm-form-control', 'type' => 'number', 'step' => '5000', 'placeholder' => '500000']
    ...
    <div class="mm-form-section">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <small class="text-muted d-block mt-2">mfano: Sinza, Mwenge, Kawe, Mikocheni, Kijitonyama</small>
            </div>
            <div class="col-md-6">
                <?= $form->field($model, 'bedrooms', [
                    'inputOptions' => ['class' => 'form-control mm-form-control', 'type' => 'number', 'min' => 0, 'placeholder' => '1']
                ])->label('<i class="bi bi-door-open me-1 text-teal"></i> ' . Yii::t('app', 'submission.field_bedrooms'), ['class' => 'mm-input-label']) ?>
            </div>

            <div class="col-12">
                <?= $form->field($model, 'description', [
                    'inputOptions' => ['class' => 'form-control mm-form-control', 'rows' => 4, 'placeholder' => 'Eleza kwa kina kuhusu ukubwa wa fremu, kando ya barabara gani, mazingira ya biashara, usalama na masharti ya malipo...']
    ...
    <div class="mm-form-section">
        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                <label class="mm-input-label"><i class="bi bi-images text-teal me-1"></i> <?= Yii::t('app', 'submission.field_images') ?> <span class="text-danger">*</span></label>
                <div class="p-4 border rounded-4 text-center bg-light" style="border: 2px dashed #cbd5e1 !important;">
                    ...
                    <input type="file" name="images[]" multiple accept="image/*" class="form-control mm-form-control mx-auto" style="max-width: 400px;" required>
                    <small class="text-muted d-block mt-2">Inasaidia picha za muundo wa JPG, PNG au WEBP (Ukubwa usiozidi 5MB kwa kila picha).</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mm-fursa-submit-area">
        <button type="submit" class="mm-submit-btn">
            <span><?= Yii::t('app', 'submission.btn_submit') ?></span>
            <i class="bi bi-check-circle-fill fs-5"></i>
        </button>
        <p class="mm-submit-trust">
            <i class="bi bi-shield-check text-success"></i> Tangazo lako litakaguliwa na kuthibitishwa moja kwa moja na timu ya MachoMtaa.
        </p>
    </div>
